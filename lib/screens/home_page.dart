...
class _MySecondState extends State<MySecond> {
  ...
  void generateImage(prompt) async {
    ...
    var apiKey =
        "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"; // Replace with your actual API key
                      ...
                      : imageUrl != ''
                          ? ClipRRect(
                              ...
                              child: Image.network(
                                ...
                                height: 400,
                                fit: BoxFit
                                    .cover, // This is optional, for how the image should be fitted into the box
                              ),
                            )
                          : Container(),
                ],
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                        filled:
                            true, // Enables the fill color of the text field
                        fillColor: Colors.grey.shade800,
                        hintText: "Enter description of the image",
                        hintStyle: TextStyle(
                            color: Colors
                                .white60 // Sets the hint text color to white
                            ),
